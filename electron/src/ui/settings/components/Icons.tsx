/**
 * Icon Components
 * All SVG icons used throughout the settings UI
 */
...
export const NarraFlowLogo = () => (
  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
    <svg width="26" height="25" viewBox="0 0 33 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient
          id="logoGradient"
          x1="0"
