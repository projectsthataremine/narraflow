...
export const MARKETING_SITE_URL = (typeof process !== 'undefined' && process.env?.NODE_ENV === 'development') ? 'http://localhost:3000' : 'https://narraflow.com';

// Edge Function Authentication
export const EDGE_FUNCTION_SECRET = (typeof process !== 'undefined' && process.env?.EDGE_FUNCTION_SECRET) || '3e78d77f2cdd92185f45378072835b1a1b32af0146610a47b23003cf917229d7';
